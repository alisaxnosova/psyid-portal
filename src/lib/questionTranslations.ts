export type LangCode = 'ru' | 'en' | 'es' | 'fr' | 'ar';
...
const T: Record<string, Omit<Record<LangCode, string>, 'ru'>> = {
  "Обычно Вы:": { en: "You are usually:", es: "Normalmente usted es:", fr: "Habituellement, vous êtes :", ar: "عادةً أنت:" },
  "Если бы Вы были преподавателем, какой курс Вы бы предпочли:": { en: "If you were a teacher, which course would you prefer:", es: "Si fuera profesor, ¿qué tipo de curso preferiría:", fr: "Si vous étiez enseignant, quel type de cours préféreriez-vous :", ar: "لو كنت معلماً، أي نوع من الدورات تفضل:" },
  "Вы чаще позволяете:": { en: "You more often let:", es: "Con más frecuencia usted permite que:", fr: "Le plus souvent, vous laissez :", ar: "في أغلب الأحيان تسمح لـ:" },
  "Когда Вы отправляетесь куда-то на весь день, Вы:": { en: "When you go somewhere for the whole day, you:", es: "Cuando sale a algún lugar por todo el día, usted:", fr: "Quand vous partez quelque part pour toute la journée, vous :", ar: "عندما تذهب إلى مكان ما لليوم بأكمله، أنت:" },
  "Находясь в компании, Вы обычно:": { en: "When in a group, you usually:", es: "Cuando está en compañía, usted generalmente:", fr: "En groupe, vous avez tendance à :", ar: "عند وجودك في مجموعة، عادةً أنت:" },
  "Вам легче поладить с людьми:": { en: "It is easier for you to get along with people who are:", es: "Le resulta más fácil llevarse bien con personas que son:", fr: "Il vous est plus facile de vous entendre avec des personnes qui sont :", ar: "من الأسهل لك التعامل مع الأشخاص الذين:" },
  "Более высокой похвалой Вы считаете слова:": { en: "You consider a greater compliment the words:", es: "Considera un mayor cumplido las palabras:", fr: "Vous considérez comme un plus grand compliment les mots :", ar: "تعتبر أعلى مديح الكلمات:" },
  "Вы предпочитаете:": { en: "You prefer:", es: "Usted prefiere:", fr: "Vous préférez :", ar: "أنت تفضل:" },
  "В большой компании чаще:": { en: "In a large group, more often:", es: "En un grupo grande, con más frecuencia:", fr: "Dans un grand groupe, le plus souvent :", ar: "في مجموعة كبيرة، في الغالب:" },
  "Вас скорее можно назвать:": { en: "You would more likely be called:", es: "Más bien se le podría llamar:", fr: "On vous qualifierait plutôt de :", ar: "يمكن وصفك بأنك:" },
  "Вы чаще добиваетесь успеха:": { en: "You more often succeed:", es: "Con más frecuencia tiene éxito:", fr: "Vous réussissez le plus souvent :", ar: "في أغلب الأحيان تنجح:" },
  "Вам больше нравятся люди, которые:": { en: "You like people who:", es: "Le gustan más las personas que:", fr: "Vous préférez les personnes qui :", ar: "تفضل الأشخاص الذين:" },
  "На Ваш взгляд самый большой недостаток – быть:": { en: "In your opinion, the greatest flaw is to be:", es: "En su opinión, el mayor defecto es ser:", fr: "À votre avis, le plus grand défaut est d'être :", ar: "في رأيك، أكبر عيب هو أن تكون:" },
  "Следование какому-либо расписанию:": { en: "Following a schedule:", es: "Seguir un horario:", fr: "Suivre un planning :", ar: "اتباع جدول زمني:" },
  "Среди своих друзей Вы:": { en: "Among your friends, you:", es: "Entre sus amigos, usted:", fr: "Parmi vos amis, vous :", ar: "بين أصدقائك، أنت:" },
  "Вы бы предпочли иметь среди своих друзей человека, который:": { en: "You would prefer to have among your friends someone who:", es: "Preferiría tener entre sus amigos a alguien que:", fr: "Vous préféreriez avoir parmi vos amis quelqu'un qui :", ar: "تفضل أن يكون من بين أصدقائك شخص:" },
  "Вы предпочли бы работать под началом человека, который:": { en: "You would prefer to work under someone who:", es: "Preferiría trabajar bajo la dirección de alguien que:", fr: "Vous préféreriez travailler sous la direction de quelqu'un qui :", ar: "تفضل العمل تحت إشراف شخص:" },
  "Мысль о том, чтобы составить список дел на выходные:": { en: "The idea of making a to-do list for the weekend:", es: "La idea de hacer una lista de tareas para el fin de semana:", fr: "L'idée de faire une liste de tâches pour le week-end :", ar: "فكرة إعداد قائمة مهام لعطلة نهاية الأسبوع:" },
  "Вы обычно:": { en: "You usually:", es: "Usted generalmente:", fr: "Vous généralement :", ar: "عادةً أنت:" },
  "Когда Вы читаете для своего удовольствия, Вам нравится:": { en: "When you read for pleasure, you like:", es: "Cuando lee por placer, le gusta:", fr: "Quand vous lisez pour le plaisir, vous aimez :", ar: "عندما تقرأ للمتعة، تحب:" },
  "Вы считаете, что более серьезный недостаток:": { en: "You think a more serious flaw is:", es: "Usted cree que un defecto más grave es:", fr: "Vous pensez qu'un défaut plus grave est :", ar: "تعتقد أن العيب الأشد خطورة هو:" },
  "В своей повседневной работе:": { en: "In your daily work:", es: "En su trabajo diario:", fr: "Dans votre travail quotidien :", ar: "في عملك اليومي:" },
  "Люди могут определить область Ваших интересов:": { en: "People can identify your areas of interest:", es: "Las personas pueden identificar sus áreas de interés:", fr: "Les gens peuvent identifier vos centres d'intérêt :", ar: "يمكن للناس تحديد مجالات اهتمامك:" },
  "Выполняя ту же работу, что и многие другие люди, Вы предпочитаете:": { en: "When doing the same work as many others, you prefer:", es: "Al hacer el mismo trabajo que muchos otros, usted prefiere:", fr: "Quand vous faites le même travail que beaucoup d'autres, vous préférez :", ar: "عند القيام بنفس العمل الذي يقوم به الآخرون، تفضل:" },
  "Вас больше волнуют:": { en: "You are more concerned with:", es: "Le preocupan más:", fr: "Vous vous souciez davantage de :", ar: "أنت أكثر اهتماماً بـ:" },
  "Когда Вам нужно выполнить определенную работу, Вы обычно:": { en: "When you need to complete a task, you usually:", es: "Cuando necesita completar una tarea, usted generalmente:", fr: "Quand vous devez accomplir une tâche, vous avez généralement tendance à :", ar: "عندما تحتاج إلى إنجاز مهمة معينة، عادةً أنت:" },
  "Когда Вам необходимо что-то сделать в определенное время, Вы считаете, что:": { en: "When you need to do something at a specific time, you feel that:", es: "Cuando necesita hacer algo en un momento determinado, usted cree que:", fr: "Quand vous devez faire quelque chose à un moment précis, vous estimez que :", ar: "عندما تحتاج إلى القيام بشيء في وقت محدد، تشعر أن:" },
  "Можно сказать, что Вы:": { en: "It can be said that you:", es: "Se puede decir que usted:", fr: "On peut dire que vous :", ar: "يمكن القول أنك:" },
  "Более высокой похвалой человеку будет признание:": { en: "A higher compliment for a person would be recognition of:", es: "Un mayor cumplido para una persona sería reconocer:", fr: "Un plus grand compliment pour une personne serait de reconnaître :", ar: "أعلى مديح للشخص هو الاعتراف بـ:" },
  "Обычно:": { en: "Usually:", es: "Normalmente:", fr: "Habituellement :", ar: "عادةً:" },
  "На вечеринках Вам:": { en: "At parties, you:", es: "En las fiestas, usted:", fr: "Lors des soirées, vous :", ar: "في الحفلات، أنت:" },
  "Вы считаете, что более важно:": { en: "You think it is more important to:", es: "Usted cree que es más importante:", fr: "Vous pensez qu'il est plus important de :", ar: "تعتقد أن الأهم هو:" },
  "Считаете ли Вы, что наличие стабильного повседневного распорядка:": { en: "Do you think that having a stable daily routine:", es: "¿Cree usted que tener una rutina diaria estable:", fr: "Pensez-vous qu'avoir une routine quotidienne stable :", ar: "هل تعتقد أن وجود روتين يومي ثابت:" },
  "Когда что-то входит в моду, Вы обычно:": { en: "When something becomes fashionable, you usually:", es: "Cuando algo se pone de moda, usted generalmente:", fr: "Quand quelque chose devient à la mode, vous avez généralement tendance à :", ar: "عندما يصبح شيء ما رائجاً، عادةً أنت:" },
  "Вы скорее:": { en: "You would rather:", es: "Usted más bien:", fr: "Vous avez plutôt tendance à :", ar: "أنت أميل إلى:" },
  "Когда Вы думаете о том, что надо сделать какое-то не очень важное дело или купить какую-то мелкую вещь, Вы:": { en: "When you think about a minor task or small purchase, you:", es: "Cuando piensa en una tarea menor o en algo pequeño que comprar, usted:", fr: "Quand vous pensez à une tâche mineure ou un petit achat, vous :", ar: "عندما تفكر في مهمة بسيطة أو شيء صغير للشراء، أنت:" },
  "Узнать, что Вы за человек:": { en: "Finding out what kind of person you are:", es: "Descubrir qué tipo de persona es usted:", fr: "Découvrir quel type de personne vous êtes :", ar: "معرفة نوع الشخص الذي أنت عليه:" },
  "Вам труднее приспособиться:": { en: "It is harder for you to adapt to:", es: "Le resulta más difícil adaptarse:", fr: "Il vous est plus difficile de vous adapter :", ar: "من الصعب عليك التأقلم مع:" },
  "Оказавшись в затруднительной ситуации, Вы обычно:": { en: "When you find yourself in an awkward situation, you usually:", es: "Cuando se encuentra en una situación difícil, usted generalmente:", fr: "Quand vous vous trouvez dans une situation embarrassante, vous avez généralement tendance à :", ar: "عند وجودك في موقف محرج، عادةً أنت:" },
  "Вы считаете, что Вашим близким известны Ваши мысли:": { en: "You think your close ones know your thoughts:", es: "Cree que sus seres queridos conocen sus pensamientos:", fr: "Vous pensez que vos proches connaissent vos pensées :", ar: "تعتقد أن المقربين منك يعرفون أفكارك:" },
  "Выполняя какую-либо работу, Вы обычно:": { en: "When doing a job, you usually:", es: "Al realizar un trabajo, usted generalmente:", fr: "Quand vous effectuez un travail, vous avez généralement tendance à :", ar: "عند القيام بعمل ما، عادةً أنت:" },
  "Будучи на вечеринке, Вы предпочитаете:": { en: "At a party, you prefer:", es: "En una fiesta, usted prefiere:", fr: "À une soirée, vous préférez :", ar: "في حفلة، تفضل:" },
  "Если в выходной утром Вас спросят, что Вы собираетесь сделать в течение дня, Вы:": { en: "If asked on a weekend morning what you plan to do during the day, you:", es: "Si le preguntan por la mañana de un día libre qué planea hacer durante el día, usted:", fr: "Si on vous demande un matin de week-end ce que vous comptez faire dans la journée, vous :", ar: "إذا سُئلت صباح يوم عطلة عما تخطط للقيام به خلال اليوم، أنت:" },
  "Однообразие повседневных дел кажется Вам:": { en: "The monotony of daily tasks seems to you:", es: "La monotonía de las tareas diarias le parece:", fr: "La monotonie des tâches quotidiennes vous semble :", ar: "يبدو لك رتابة المهام اليومية:" },
  "Когда Вам нужно выполнить определенную работу, Вы обычно:": { en: "When you need to complete a certain task, you usually:", es: "Cuando necesita completar una tarea específica, usted generalmente:", fr: "Quand vous devez accomplir une tâche précise, vous avez généralement tendance à :", ar: "عندما تحتاج إلى إنجاز مهمة معينة، عادةً أنت:" },
  "Когда Вы начинаете какое-то большое дело, которое займет у Вас неделю, Вы:": { en: "When you start a big project that will take a week, you:", es: "Cuando comienza un gran proyecto que le llevará una semana, usted:", fr: "Quand vous commencez un grand projet qui vous prendra une semaine, vous :", ar: "عند بدء مشروع كبير سيستغرق منك أسبوعاً، أنت:" },
  "Какое слово из пары (А или Б) Вам больше нравится:": { en: "Which word from the pair (A or B) do you prefer:", es: "¿Cuál de las palabras del par (A o B) prefiere:", fr: "Quel mot de la paire (A ou B) préférez-vous :", ar: "أي كلمة من الزوج (أ أو ب) تفضل:" },
