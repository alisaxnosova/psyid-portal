#!/usr/bin/env python3
"""Build the standalone ReNo v1.2 preview.

Inlines the real, already-created v1.2 content into a single self-contained HTML
...
Output:             docs/reno/preview/reno-v1.2-preview.html
"""
import json, pathlib
...
dest = HERE / "reno-v1.2-preview.html"
